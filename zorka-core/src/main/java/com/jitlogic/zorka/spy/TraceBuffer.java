...
import com.jitlogic.zorka.cbor.CBORConstants;

import java.io.OutputStream;
import java.util.List;
import java.util.Map;

public class TraceBuffer extends OutputStream {

    protected TraceBufManager bufManager;
    protected TraceBufChunk chunk = null;
    ...
    /** Trace buffer output */
    protected TraceBufOutput output;


    public TraceBuffer(TraceBufManager bufManager) {
    ...
    protected void nextChunk() {
        ...
        TraceBufChunk ch = bufManager.get();
    ...
    public void writeFloat(float f) {
        ...
        if (bufLen - bufPos < 5) nextChunk();
        buffer[bufPos] = (byte)CBORConstants.FLOAT_BASE4;
        buffer[bufPos+1] = (byte)((i >> 24) & 0xff);
        buffer[bufPos+2] = (byte)((i >> 16) & 0xff);
        buffer[bufPos+3] = (byte)((i >> 8) & 0xff);
        buffer[bufPos+4] = (byte)(i & 0xff);
    ...
    public void writeDouble(double d) {
        ...
        buffer[bufPos] = (byte)CBORConstants.FLOAT_BASE8;
        buffer[bufPos + 1] = (byte)((l >> 56) & 0xff);
        buffer[bufPos + 2] = (byte)((l >> 48) & 0xff);
        buffer[bufPos + 3] = (byte)((l >> 40) & 0xff);
        buffer[bufPos + 4] = (byte)((l >> 32) & 0xff);
    ...
    public void writeObject(Object obj) {
        ...
        if (c == Byte.class || c == Short.class || c == Integer.class) {
            ...
            write(CBORConstants.FALSE_CODE);
        } else if (obj == Boolean.TRUE) {
            write(CBORConstants.TRUE_CODE);
        } else if (obj == CBORConstants.BREAK) {
            write(CBORConstants.BREAK_CODE);
        } else if (c == Float.class) {
            writeFloat((Float)obj);
        } else if (c == Double.class) {
            writeDouble((Double)obj);
        } else if (obj == CBORConstants.UNKNOWN) {
            write(CBORConstants.UNKNOWN_CODE);
        }
    }
