...
import com.jitlogic.zorka.util.ZorkaUnsafe;
import com.jitlogic.zorka.util.ZorkaUtil;
import com.jitlogic.zorka.spy.TraceBufChunk;
import com.jitlogic.zorka.spy.TraceBufManager;
import com.jitlogic.zorka.test.spy.support.TestTraceBufOutput;
import com.jitlogic.zorka.test.spy.support.TestTraceRecorder;
...
import static com.jitlogic.zorka.util.ZorkaUnsafe.*;

import static com.jitlogic.zorka.test.spy.support.TraceCborUtils.*;

public class TraceRecorderUnitTest extends ZorkaFixture {
    ...
    public void fastIntWriter(byte[] b, int v) {
        for (int pos = 0; pos < b.length; pos += 4) {
            UNSAFE.putInt(b, pos+BYTE_ARRAY_OFFS, v);
        }
    }
    ...
    public void fastShortWriter(byte[] b, short v) {
        for (int pos = 0; pos < b.length; pos += 2) {
            UNSAFE.putShort(b, pos+BYTE_ARRAY_OFFS, v);
        }
    }
    ...
    public void testEndianness() {
        ...
        UNSAFE.putLong(b, BYTE_ARRAY_OFFS, v);
