...
import com.jitlogic.zorka.spy.TraceRecorder;
...
import static com.jitlogic.zorka.spy.TraceFormat.*;
    ...
    public Object process(int tag, Object obj) {
        if (tag == TAG_TRACE_START) {
            ...
            if (obj0 instanceof byte[]) {
                ...
                rec.put("tstart", l & TraceRecorder.TSTAMP_MASK);
                rec.put("method", l >> TraceRecorder.TSTAMP_BITS);
            } else {
            ...
            if (objN instanceof byte[]) {
                ...
                rec.put("tstop", l & TraceRecorder.TSTAMP_MASK);
                rec.put("calls", l >> TraceRecorder.TSTAMP_BITS);
            } else {
