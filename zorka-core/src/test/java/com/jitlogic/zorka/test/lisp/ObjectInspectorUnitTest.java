...
import com.jitlogic.zorka.lisp.JmxObject;
import com.jitlogic.zorka.lisp.ObjectInspector;
import com.jitlogic.zorka.lisp.Utils;
import com.jitlogic.zorka.test.lisp.support.TestInspectorClass;
import com.jitlogic.zorka.test.lisp.support.TestInspectorClass2;
import com.jitlogic.zorka.test.lisp.support.TestJmx;
import com.jitlogic.zorka.test.lisp.support.TestStats;
...
public class ObjectInspectorUnitTest {
    ...
    public void testInspectStatic() {
        ...
        assertEquals((Object)126, ObjectInspector.get(TestInspectorClass.class, "count()"));
        assertEquals((Object)123, ObjectInspector.get(TestInspectorClass.class, ".count"));
        assertEquals((Object)234, ObjectInspector.get(TestInspectorClass.class, ".priv"));

        // Automatic resolve
        assertEquals((Object)125, ObjectInspector.get(TestInspectorClass.class, "count"));
    }
    ...
    public void testInspectByteArrayLength() {
        byte[] array = {1, 2, 3};
        assertEquals((Object)3, ObjectInspector.get(array, "length"));
        assertEquals((Object)(byte) 2, ObjectInspector.get(array, 1));
    }
    ...
    public void testInspectIntArrayLength() {
        int[] array = {1, 2, 3};
        assertEquals((Object)3, ObjectInspector.get(array, "length"));
        assertEquals((Object)2, ObjectInspector.get(array, 1));
    }
    ...
    public void testInspectLongArrayLength() {
        long[] array = {1, 2, 3};
        assertEquals((Object)3, ObjectInspector.get(array, "length"));
        assertEquals((Object)2L, ObjectInspector.get(array, 1));
    }
    ...
    public void testInspectJmxObj() throws Exception {
        ...
        assertEquals((Object)100L, ObjectInspector.get(jmxObject, "Nom"));
    }
    ...
    public void testRecordSubstitutions() {
        Map<String, Object> rec = Utils.map("E0", "123", "E1", "4567", "R0", "aaa", "R1", "bbb");
    ...
    public void testSubstituteSpecialChars() {
        Map<String, Object> rec = Utils.map("A", "a $ b");
    ...
    public void testSubstituteWithDefaultVal1() {
        ...
        assertEquals("ABC", ObjectInspector.substitute("${X:XXX}", Utils.<String, Object>map("X", "ABC")));
    ...
    public void testSubstituteWithLimit() {
        assertEquals("ABC", ObjectInspector.substitute("${X~3}", Utils.<String, Object>map("X", "ABCDEF")));
    ...
    public void testSubstituteWithDefaultAndLimit() {
        assertEquals("AB.YY", ObjectInspector.substitute("${X~2:XX}.${Y~2:YY}",
            Utils.<String, Object>map("X", "ABCD")));
